...
describe('cmdTemplateSelect', () => {
  ...
  test('returns template info for a plan with few tasks', () => {
    ...
    const { stdout, exitCode } = captureOutput(() => {
      cmdTemplateSelect(fixtureDir, '.planning/milestones/anonymous/phases/01-test/01-01-PLAN.md', false);
    });
...
describe('cmdScaffold', () => {
  ...
  test('scaffold research-dir creates research directory structure', () => {
    ...
    const deepDivesPath = path.join(fixtureDir, '.planning', 'milestones', 'anonymous', 'research', 'deep-dives');
