...
- v0.1.0 Setup Functionality & Usability - Phases 9-13 (shipping)
...
**Plans**: 2 plans
Plans:
- [x] 12-01-PLAN.md -- TDD: Add refineMilestone, promoteMilestone, getMilestoneTier, updateRefinementHistory to lib/long-term-roadmap.js (Wave 1)
- [x] 12-02-PLAN.md -- Add refine/promote/tier/history CLI subcommands with comprehensive tests (Wave 2)
...
**Phases 14-15 deferred to v0.1.1.**
...
| Phase 9 | Backend detection accuracy across real environments (mocked in unit tests) | v0.1.1 | Pending |
| Phase 10 | Context init backward compatibility under all 4 backends | v0.1.1 | Pending |
| Phase 11 | Long-term roadmap round-trip integrity (create -> refine -> promote -> generate) | v0.1.1 | Pending |
| Phase 13 | Auto-cleanup does not interfere with normal phase execution when disabled | v0.1.1 | Pending |
