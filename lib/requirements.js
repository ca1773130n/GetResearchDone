/**
 * GRD Requirements -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./requirements')` resolves to .js before .ts. The canonical
 * implementation lives in requirements.ts; this proxy re-exports it.
 *
...
module.exports = require('./requirements.ts');
