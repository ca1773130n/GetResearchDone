/**
 * GRD State Operations -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./state')` resolves to .js before .ts. The canonical
 * implementation lives in state.ts; this proxy re-exports it.
 *
...
module.exports = require('./state.ts');
