/**
 * GRD Phase Lifecycle Operations -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./phase')` resolves to .js before .ts. The canonical
 * implementation lives in phase.ts; this proxy re-exports it.
 *
...
module.exports = require('./phase.ts');
