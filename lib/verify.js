/**
 * GRD Verification Suite -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./verify')` resolves to .js before .ts. The canonical
 * implementation lives in verify.ts; this proxy re-exports it.
 *
...
module.exports = require('./verify.ts');
