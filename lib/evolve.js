...
async function discoverWithClaude(cwd) {
  ...
  const attempts = [
    { maxTurns: 5, timeout: 300_000 },
    { maxTurns: 8, timeout: 600_000 },
  ];
  ...
  // All attempts failed — return empty, do NOT fall back to hardcoded GRD-specific scanning
  return [];
}
