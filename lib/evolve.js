/**
 * GRD Evolve -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./evolve')` resolves to .js before .ts. The canonical
 * implementation lives in evolve/index.ts; this proxy re-exports it.
 *
