/**
 * GRD Phase Cleanup -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./cleanup')` resolves to .js before .ts. The canonical
 * implementation lives in cleanup.ts; this proxy re-exports it.
 *
...
module.exports = require('./cleanup.ts');
