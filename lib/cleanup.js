...
const CLEANUP_DEFAULTS = { enabled: false, refactoring: false, doc_sync: false, cleanup_threshold: 5 };
 ...
 * @returns {{ enabled: boolean, refactoring: boolean, doc_sync: boolean, cleanup_threshold: number }}
 */
