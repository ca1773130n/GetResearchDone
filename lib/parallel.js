/**
 * GRD Parallel Execution -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./parallel')` resolves to .js before .ts. The canonical
 * implementation lives in parallel.ts; this proxy re-exports it.
 *
