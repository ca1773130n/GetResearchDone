/**
 * GRD Backend Detection -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./backend')` resolves to .js before .ts. The canonical
 * implementation lives in backend.ts; this proxy re-exports it.
 *
...
module.exports = require('./backend.ts');
