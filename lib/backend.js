 ...
 * @type {Object.<string, {subagents: boolean|string, parallel: boolean, teams: boolean, hooks: boolean, mcp: boolean, native_worktree_isolation: boolean}>}
 */
const BACKEND_CAPABILITIES = {
  claude: { subagents: true, parallel: true, teams: true, hooks: true, mcp: true, native_worktree_isolation: true },
  codex: { subagents: true, parallel: true, teams: false, hooks: false, mcp: true, native_worktree_isolation: false },
  gemini: { subagents: 'experimental', parallel: false, teams: false, hooks: true, mcp: true, native_worktree_isolation: false },
  opencode: { subagents: true, parallel: true, teams: false, hooks: true, mcp: true, native_worktree_isolation: false },
};
 ...
 *
 * @param {string} backend - Backend identifier
 * @returns {{subagents: boolean|string, parallel: boolean, teams: boolean, hooks: boolean, mcp: boolean, native_worktree_isolation: boolean}} Capability flags
 */
