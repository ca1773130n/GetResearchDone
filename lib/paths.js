 ...
 *
 * Returns the new-style path (.planning/milestones/{milestone}/standards/) when the
 * milestone directory exists on disk, otherwise falls back to .planning/standards/.
 *
 * @param {string} cwd - Project working directory
 * @param {string} [milestone] - Milestone version; defaults to currentMilestone(cwd)
 * @returns {string} Absolute path to standards directory (new or old layout)
 */
