/**
 * GRD Path Resolution -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./paths')` resolves to .js before .ts. The canonical
 * implementation lives in paths.ts; this proxy re-exports it.
 *
...
module.exports = require('./paths.ts');
