  ...
  },
  {
    ...
    params: [
      { name: 'project', type: 'string', required: false, description: 'Project name' },
      {
        ...
        type: 'string',
        required: false,
        description: 'Planning horizon (e.g. "6 months")',
      },
      {
        name: 'milestones',
        type: 'string',
        required: true,
        description: 'JSON string of milestone definitions',
      },
    ],
    execute: (cwd, args) => {
      const subArgs = [];
      if (args.project) {
        subArgs.push('--project', args.project);
      }
      if (args.horizon) {
        subArgs.push('--horizon', args.horizon);
      }
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: 'Milestone version to refine',
      },
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: 'Milestone version to promote',
      },
    ],
    execute: (cwd, args) => cmdLongTermRoadmap(cwd, 'promote', ['--version', args.version], false),
  },
  {
    name: 'grd_long_term_roadmap_tier',
    description: 'Get the tier of a milestone',
    params: [{ name: 'version', type: 'string', required: true, description: 'Milestone version' }],
    execute: (cwd, args) => cmdLongTermRoadmap(cwd, 'tier', ['--version', args.version], false),
  },
  {
