...
const COMMAND_DESCRIPTORS = [
  // ── State commands ──
  {
    ...
    params: [],
    execute: (cwd, args) => cmdStateLoad(cwd, false),
  },
  {
    name: 'grd_state_get',
    description: 'Read a specific field or section from STATE.md',
    params: [
      { name: 'section', type: 'string', required: false, description: 'Field or section name to read' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'patches', type: 'object', required: true, description: 'Object of field:value pairs to update' },
    ],
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdStateAdvancePlan(cwd, false),
  },
  {
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdStateUpdateProgress(cwd, false),
  },
  {
    ...
    params: [
      ...
      { name: 'phase', type: 'string', required: false, description: 'Phase number for the decision' },
      { name: 'rationale', type: 'string', required: false, description: 'Rationale for the decision' },
    ],
    execute: (cwd, args) =>
  ...
  },
  {
    ...
    params: [
      { name: 'text', type: 'string', required: true, description: 'Blocker description' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'stopped_at', type: 'string', required: true, description: 'Where execution stopped' },
  ...
  // ── Top-level commands ──
  {
    ...
    params: [
      { name: 'agent_type', type: 'string', required: true, description: 'Agent type key (e.g. grd-executor)' },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'files', type: 'array', required: false, description: 'File paths to stage (defaults to .planning/)' },
  ...
  },
  {
    ...
    params: [
      { name: 'hashes', type: 'array', required: true, description: 'Array of git commit hashes to verify' },
    ],
  ...
  // ── Template & Scaffold ──
  {
    ...
    params: [
      { name: 'type', type: 'string', required: true, description: 'Template type (e.g. summary, plan)' },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'type', type: 'string', required: false, description: 'Plan type (default: execute)' },
      { name: 'wave', type: 'string', required: false, description: 'Wave number (default: 1)' },
      { name: 'fields', type: 'object', required: false, description: 'Additional template fields' },
    ],
    execute: (cwd, args) =>
      cmdTemplateFill(cwd, args.template, {
        phase: args.phase || null,
        plan: args.plan || null,
        name: args.name || null,
  ...
  },
  {
    ...
    params: [
      { name: 'file', type: 'string', required: true, description: 'Markdown file path' },
      { name: 'schema', type: 'string', required: false, description: 'Schema name to validate against' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'format', type: 'string', required: false, description: 'Format: date, filename, or full (default: full)' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'filename', type: 'string', required: true, description: 'Todo filename to complete' },
    ],
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdConfigEnsureSection(cwd, false),
  },
  {
    name: 'grd_config_set',
    description: 'Set a configuration value by dot-path key in config.json',
    params: [
      { name: 'key', type: 'string', required: true, description: 'Dot-notation key path (e.g. workflow.research)' },
      { name: 'value', type: 'string', required: true, description: 'Value to set' },
    ],
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdHistoryDigest(cwd, false),
  },
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdRoadmapAnalyze(cwd, false),
  },
  ...
  // ── Phase operations ──
  {
    ...
    params: [
      { name: 'phase', type: 'string', required: true, description: 'Base phase number' },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'force', type: 'boolean', required: false, description: 'Force removal even if phase has content' },
    ],
  ...
  // ── Milestone ──
  {
    ...
    params: [
      { name: 'version', type: 'string', required: true, description: 'Milestone version (e.g. v1.0)' },
  ...
  // ── Validate ──
  {
    ...
    params: [],
    execute: (cwd, args) => cmdValidateConsistency(cwd, false),
  },
  ...
  // ── Progress ──
  {
    ...
    params: [
      { name: 'format', type: 'string', required: false, description: 'Output format: json, table, or bar (default: json)' },
    ],
  ...
  // ── State Snapshot ──
  {
    ...
    params: [],
    execute: (cwd, args) => cmdStateSnapshot(cwd, false),
  },
  ...
  // ── Summary Extract ──
  {
    ...
    params: [
      { name: 'file', type: 'string', required: true, description: 'Path to the SUMMARY.md file' },
      { name: 'fields', type: 'string', required: false, description: 'Comma-separated list of fields to extract' },
    ],
    execute: (cwd, args) =>
  ...
  // ── Tracker (12 subcommands) ──
  {
    ...
    params: [],
    execute: (cwd, args) => cmdTracker(cwd, 'get-config', [], false),
  },
  {
    name: 'grd_tracker_sync_roadmap',
    description: 'Sync roadmap to issue tracker',
    params: [],
    execute: (cwd, args) => cmdTracker(cwd, 'sync-roadmap', [], false),
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'phase', type: 'string', required: true, description: 'Phase number' },
      { name: 'file', type: 'string', required: true, description: 'Path to file to post as comment' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'args', type: 'array', required: true, description: 'Mapping arguments' },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'args', type: 'array', required: true, description: 'Status arguments' },
    ],
  ...
  // ── Dashboard, Phase Detail, Health ──
  {
    ...
    params: [],
    execute: (cwd, args) => cmdDashboard(cwd, true),
  },
  {
  ...
  // ── Init workflows (21 total) ──
  {
    ...
    execute: (cwd, args) =>
      cmdInitExecutePhase(cwd, args.phase, new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    ...
    execute: (cwd, args) =>
      cmdInitPlanPhase(cwd, args.phase, new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_new_project',
    description: 'Initialize context for new-project workflow',
    params: [],
    execute: (cwd, args) => cmdInitNewProject(cwd, false),
  },
  {
    name: 'grd_init_new_milestone',
    description: 'Initialize context for new-milestone workflow',
    params: [],
    execute: (cwd, args) => cmdInitNewMilestone(cwd, false),
  },
  {
    name: 'grd_init_quick',
    description: 'Initialize context for quick workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Quick task description' },
    ],
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdInitResume(cwd, false),
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'area', type: 'string', required: false, description: 'Area filter' },
    ],
  ...
  },
  {
    ...
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'survey', args.topic || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    ...
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'deep-dive', args.paper || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    ...
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'feasibility', args.approach || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_eval_plan',
    description: 'Initialize context for eval-plan research workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Evaluation plan description' },
      { name: 'include', type: 'string', required: false, description: 'Comma-separated include items' },
    ],
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'eval-plan', args.description || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_eval_report',
    description: 'Initialize context for eval-report research workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Evaluation report description' },
      { name: 'include', type: 'string', required: false, description: 'Comma-separated include items' },
    ],
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'eval-report', args.description || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_assess_baseline',
    description: 'Initialize context for assess-baseline research workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Baseline assessment description' },
      { name: 'include', type: 'string', required: false, description: 'Comma-separated include items' },
    ],
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'assess-baseline', args.description || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_product_plan',
    description: 'Initialize context for product-plan workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Product plan description' },
      { name: 'include', type: 'string', required: false, description: 'Comma-separated include items' },
    ],
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'product-plan', args.description || '', new Set(args.include ? args.include.split(',') : []), false),
  },
  {
    name: 'grd_init_iterate',
    description: 'Initialize context for iterate workflow',
    params: [
      { name: 'description', type: 'string', required: false, description: 'Iteration description' },
      { name: 'include', type: 'string', required: false, description: 'Comma-separated include items' },
    ],
    execute: (cwd, args) =>
      cmdInitResearchWorkflow(cwd, 'iterate', args.description || '', new Set(args.include ? args.include.split(',') : []), false),
  },

  // ── Long-Term Roadmap (9 subcommands) ──
  {
  ...
  },
  {
    ...
    params: [],
    execute: (cwd, args) => cmdLongTermRoadmap(cwd, 'display', [], false),
  },
  {
    name: 'grd_long_term_roadmap_mode',
    description: 'Get the current planning mode (flat or hierarchical)',
    params: [],
    execute: (cwd, args) => cmdLongTermRoadmap(cwd, 'mode', [], false),
  },
  {
    name: 'grd_long_term_roadmap_generate',
    description: 'Generate a new long-term roadmap from milestone definitions',
    params: [
      { name: 'project', type: 'string', required: false, description: 'Project name' },
      { name: 'horizon', type: 'string', required: false, description: 'Planning horizon (e.g. "6 months")' },
      { name: 'milestones', type: 'string', required: true, description: 'JSON string of milestone definitions' },
    ],
    execute: (cwd, args) => {
      const subArgs = [];
      if (args.project) { subArgs.push('--project', args.project); }
      if (args.horizon) { subArgs.push('--horizon', args.horizon); }
      subArgs.push('--milestones', args.milestones);
      return cmdLongTermRoadmap(cwd, 'generate', subArgs, false);
    },
  },
  {
    name: 'grd_long_term_roadmap_refine',
    description: 'Refine a milestone in the long-term roadmap',
    params: [
      { name: 'version', type: 'string', required: true, description: 'Milestone version to refine' },
      { name: 'updates', type: 'string', required: true, description: 'JSON string of updates' },
    ],
    execute: (cwd, args) =>
      cmdLongTermRoadmap(cwd, 'refine', ['--version', args.version, '--updates', args.updates], false),
  },
  {
    name: 'grd_long_term_roadmap_promote',
    description: 'Promote a milestone to the next tier',
    params: [
      { name: 'version', type: 'string', required: true, description: 'Milestone version to promote' },
    ],
    execute: (cwd, args) =>
      cmdLongTermRoadmap(cwd, 'promote', ['--version', args.version], false),
  },
  {
    name: 'grd_long_term_roadmap_tier',
    description: 'Get the tier of a milestone',
    params: [
      { name: 'version', type: 'string', required: true, description: 'Milestone version' },
    ],
    execute: (cwd, args) =>
      cmdLongTermRoadmap(cwd, 'tier', ['--version', args.version], false),
  },
  {
    ...
    execute: (cwd, args) =>
      cmdLongTermRoadmap(cwd, 'history', ['--action', args.action, '--details', args.details], false),
  },
