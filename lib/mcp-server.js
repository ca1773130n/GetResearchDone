...
const { cmdAutopilot, cmdInitAutopilot } = require('./autopilot');
const {
  cmdEvolve,
  cmdEvolveDiscover,
  cmdEvolveState,
...
// lib/mcp-descriptors.js because every execute handler directly references
 ...
 * @param {string} name - MCP tool name (e.g. 'grd_find_phase')
 * @param {string} description - Tool description
 * @param {string} argName - Name of the single required string argument
 * @param {string} argDescription - Description of the argument
 * @param {Function} handler - (cwd, argValue) => result
 ...
 * @param {string} description - Tool description
 * @param {Function} handler - (cwd, phase) => result
 * @returns {Object} Descriptor
 */
 ...
 * @param {string} name - MCP tool name
 * @param {string} description - Tool description
 * @param {Function} handler - (cwd) => result
 * @returns {Object} Descriptor
 */
...
const COMMAND_DESCRIPTORS = [
  ...
  // ── Roadmap ──
  makePhaseCommand('grd_roadmap_get_phase', 'Get roadmap section for a specific phase', (cwd, phase) =>
    cmdRoadmapGetPhase(cwd, phase, false)
  ),
  {
