/**
 * GRD Markdown Splitting -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./markdown-split')` resolves to .js before .ts. The canonical
 * implementation lives in markdown-split.ts; this proxy re-exports it.
 *
...
module.exports = require('./markdown-split.ts');
