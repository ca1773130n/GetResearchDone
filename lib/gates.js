/**
 * GRD Validation Gate System -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./gates')` resolves to .js before .ts. The canonical
 * implementation lives in gates.ts; this proxy re-exports it.
 *
...
module.exports = require('./gates.ts');
