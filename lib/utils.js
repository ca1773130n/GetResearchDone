/**
 * GRD Shared Utilities -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./utils')` resolves to .js before .ts. The canonical
 * implementation lives in utils.ts; this proxy re-exports it.
 *
