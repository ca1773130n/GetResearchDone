/**
 * GRD Dependency Analysis -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./deps')` resolves to .js before .ts. The canonical
 * implementation lives in deps.ts; this proxy re-exports it.
 *
...
module.exports = require('./deps.ts');
