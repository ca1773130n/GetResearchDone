...
/**
 * CLI command: Manage long-term roadmap operations (parse, validate, display, mode, generate).
 * @param {string} cwd - Project working directory
 * @param {string} subcommand - One of: 'parse', 'validate', 'display', 'mode', 'generate'
...
function cmdLongTermRoadmap(cwd, subcommand, args, raw) {
  switch (subcommand) {
    ...
    default:
      error('Unknown subcommand: ' + subcommand + '. Valid: parse, validate, display, mode, generate');
  }
}
