/**
 * GRD Scaffold Operations -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./scaffold')` resolves to .js before .ts. The canonical
 * implementation lives in scaffold.ts; this proxy re-exports it.
 *
...
module.exports = require('./scaffold.ts');
