/**
 * GRD Tracker Integration -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./tracker')` resolves to .js before .ts. The canonical
 * implementation lives in tracker.ts; this proxy re-exports it.
 *
...
module.exports = require('./tracker.ts');
