...
function cmdWorktreeRemove(cwd, options, raw) {
  ...
  if (options.path) {
    ...
    error('Either --phase or --path is required for worktree remove. Usage: worktree remove --phase <N> OR worktree remove --path <worktree-path>. Provide one of: --phase 2 or --path .worktrees/grd/v1.0/02-slug');
  }
