...
function cmdWorktreeRemove(cwd, options, raw) {
  ...
  if (options.path) {
    ...
    error('Either --phase or --path is required for worktree remove. Specify which worktree to remove using --phase <N> or --path <worktree-path>. Example: worktree remove --phase 3');
  }
