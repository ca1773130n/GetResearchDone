/**
 * GRD Roadmap Operations -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./roadmap')` resolves to .js before .ts. The canonical
 * implementation lives in roadmap.ts; this proxy re-exports it.
 *
...
module.exports = require('./roadmap.ts');
