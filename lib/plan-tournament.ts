...
function _extractRoadmapGoal(roadmap: string, phaseNumber: string): string | null {
  // codex r3 P2 on PR #41: ROADMAP headings may use padded forms
  // (`Phase 06.1`) for decimal phases generated by `gd phase insert`.
  // Build the per-component number pattern to accept optional leading
  // zeros at each level so both `Phase 6.1` and `Phase 06.1` match the
  // same phase-number argument.
