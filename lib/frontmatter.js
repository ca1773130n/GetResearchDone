/**
 * GRD Frontmatter Operations -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./frontmatter')` resolves to .js before .ts. The canonical
 * implementation lives in frontmatter.ts; this proxy re-exports it.
 *
