...
function cmdInitExecutePhase(cwd, phase, includes, raw) {
  if (!phase) {
    error('phase required for init execute-phase. Usage: init execute-phase <phase-number>. Provide a phase number, e.g.: init execute-phase 2');
  }
...
function cmdInitPlanPhase(cwd, phase, includes, raw) {
  if (!phase) {
    error('phase required for init plan-phase. Usage: init plan-phase <phase-number>. Provide a phase number, e.g.: init plan-phase 2');
  }
