...
function cmdInitExecutePhase(cwd, phase, includes, raw) {
  if (!phase) {
    error('phase required for init execute-phase. Usage: init execute-phase <phase-number>');
  }
...
function cmdInitPlanPhase(cwd, phase, includes, raw) {
  if (!phase) {
    error('phase required for init plan-phase. Usage: init plan-phase <phase-number>');
  }
