/**
 * GRD Autopilot -- CommonJS re-export proxy
 *
 * This file exists solely for runtime compatibility: plain Node.js
 * `require('./autopilot')` resolves to .js before .ts. The canonical
 * implementation lives in autopilot.ts; this proxy re-exports it.
 *
